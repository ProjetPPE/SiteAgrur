...
<img src="images/logo-noix.jpg"/>
    <nav id="menu">
		<ul>    
			<li class="icon"><a class="nav" href="index.php">Accueil</a></li> 
            <li class="icon"><a class="nav" href="consulter.php">Consulter</a></li>
            <li class="icon"><a class="nav" href="ajouterHTML.php">Ajouter</a></li>
			<li class="icon"><a class="nav" href="modifier.php">Modifier</a></li>
            <li id ="menuDeroulant" class="icon"><a class="nav" href="inscription.php">Inscription</a></li>
        </ul>
	</nav>
</header>